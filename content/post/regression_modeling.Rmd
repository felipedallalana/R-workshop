...
model_b <- with(aphids_data, lm(aphids ~ temperature + humidity + I(temperature^2) + I(humidity^2) + temperature:humidity))
...
anova(model_a, model_b3) ## this model is close to p=0,05 and probably has some predictive value

# Remove temperature^2
...
# Both directions 
both <- step(model_b, direction="both")
