...
```{r Linear Model with logit bionomial distribution because violation of normality assumption, warning=FALSE}
#logit binomial dist
...
```{r Compare DR and LM model, message=FALSE, warning=FALSE}
...
```{r Compare DR and LM models, message=FALSE, warning=FALSE}
#compare linear model with DR, linear > DR due to lower AIC
